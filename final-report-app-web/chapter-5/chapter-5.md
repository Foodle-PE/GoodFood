...
<tr>
    ...
    <td colspan="8">En esta primera sección se planteó el desarrollo de la Landing Page para el proyecto de GoodFood.</td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="8">En esta segunda sección se planteó el desarrollo del capítulo 1 para el proyecto de GoodFood.</td>
</tr>
<tr>
    <td colspan="5">Sprint 2 Retrospective Summary</td>
    <td colspan="8">En esta sección todos los integrantes mencionaron tener en claro de qué se tratará GoodFood.</td>
</tr>
<tr>
    <td colspan="13">Sprint Goal</td>
</tr>
<tr>
    ...
    <td colspan="8">
Desarrollar el startup profile, antecedentes, plantear las problemáticas y seguir los principios Lean UX.</td>
</tr>
</table>
...
<tr>
    ...
    <td colspan="8">En esta tercera sección se planteó el desarrollo del capítulo 2 para el proyecto de GoodFood.</td>
</tr>
<tr>
    <td colspan="5">Sprint 3 Retrospective Summary</td>
    <td colspan="8">En esta sección todos los integrantes mencionaron tener los contactos necesarios para llevar a cabo el desarrollo de los puntos a tratar.</td>
</tr>
<tr>
    <td colspan="13">Sprint Goal</td>
</tr>
<tr>
    ...
    <td colspan="8">
Planear las entrevistas y delegar el análisis a los miembros del equipo de desarrollo y coordinar la realización del Needfinding.</td>
</tr>
</table>
...
<tr>
  ...
  <tr>
    <td colspan="5">Date</td>
    <td colspan="8">2025-04-21</td>
</tr>
  <tr>
    <td colspan="5">Time</td>
    <td colspan="8">6:15 PM</td>
  </tr>
  <tr>
    <td colspan="5">Location</td>
    <td colspan="8">Via Discord</td>
...
<tr>
    ...
    <td colspan="8">En esta cuarta sección se planteó el desarrollo del capítulo 3 para el proyecto de GoodFood.</td>
</tr>
<tr>
    <td colspan="5">Sprint 4 Retrospective Summary</td>
    <td colspan="8">En esta sección todos los integrantes mencionaron tener experiencia en el desarrollo de User Stories para GoodFood.</td>
</tr>
<tr>
    <td colspan="13">Sprint Goal</td>
</tr>
<tr>
    ...
    <td colspan="8">
Desarrollo de historias de usuario, product backlog y épicas para la finalización del capítulo 3 del reporte requerido.</td>
</tr>
</table>

<table>
<tr>
    <th colspan="5">Sprint 5</th>
    <th colspan="9">Sprint 5</th>
  </tr>
      <tr>
    <td colspan="13">Sprint Planning Background</td>
  </tr>
...
<tr>
    <td colspan="5">Sprint 5 Review Summary</td>
    <td colspan="8">En esta quinta sección se planteó el desarrollo del capítulo 4 para el proyecto de GoodFood.</td>
</tr>
<tr>
    <td colspan="5">Sprint 5 Retrospective Summary</td>
    <td colspan="8">En esta sección todos los integrantes mencionaron haber avanzado con los diseños de wireframes y mockups como se quedó en la primera sesión de trabajo.</td>
</tr>
<tr>
    <td colspan="13">Sprint Goal</td>
</tr>
<tr>
    <td colspan="5">Sprint 5 Goal</td>
    <td colspan="8">
Desarrollo entero de documentación respecto a la creación de landing page: Wireframes, mockups, wireflows, user flows, labeling system, information architecture y el syle guidelines.</td>
</tr>
</table>

<table>
<tr>
    <th colspan="5">Sprint 6</th>
    <th colspan="9">Sprint 6</th>
  </tr>
      <tr>
    <td colspan="13">Sprint Planning Background</td>
  </tr>
...
<tr>
    <td colspan="5">Sprint 6 Review Summary</td>
    <td colspan="8">En esta sexta sección se planteó el desarrollo del capítulo 5 para el proyecto de GoodFood.</td>
</tr>
<tr>
    <td colspan="5">Sprint 6 Retrospective Summary</td>
    <td colspan="8">En esta sección todos los integrantes mencionaron que la validación de los productos realizados sería terminada el mismo día de la sesión.</td>
</tr>
<tr>
    <td colspan="13">Sprint Goal</td>
</tr>
<tr>
    <td colspan="5">Sprint 6 Goal</td>
    <td colspan="8">
Desarrollo del último capítulo del reporte, corrección de errores previos y finalización de ToDo's</td>
</tr>
</table>
